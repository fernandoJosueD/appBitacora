...
import com.example.myapplication.Mostrar.imc
...
class updateSetPersona : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        editTextTextPersonName4.setOnClickListener { startActivity(Intent(this,imc::class.java)) }
...
//------recoge el id y correo de usuario para validar el ingreso a datos personales
            ...
            FirebaseFirestore.getInstance()
                ...
                .get().addOnSuccessListener { documentSnapshot ->
                    try {
                        ...
                        textleerAltura.text = "mi altura es $valorAltura m"
                        textleerEdad.text = "mi edad es $miEdad años"
                        textleerPeso.text = "mi peso es $miPeso.Lbs"
                    } catch (e:NullPointerException){
                        Toast.makeText(this,"no existen registros aun",Toast.LENGTH_SHORT).show()
                    }
    ...
    fun actualizar ():Boolean{
        ...
        var nom: String = editactualizarNombre.text.toString()
        var segnom:String= editactualizarNombredos.text.toString()
        var ape: String = editactualizarApellido.text.toString()
        var eda: String = editactualizarEdad.text.toString()
        var pes: String = editactualizarPesoLibras.text.toString()
        var alt: String = editactualizarAltura.text.toString()
        var ofi:String  = editactualizaroficio.text.toString()
        var cent:String = editactualizarcentroestudio.text.toString()
        var fac: String = editactualizarfacultad.text.toString()
